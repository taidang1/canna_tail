    ...
    return (
        <div className="py-14 bg-white">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                We use the latest and best in-class technologies available to ensure your cannabis software stays ahead of the competition.
                    </p>
                </div>
                <div className="mt-12 flex justify-center ">
                    <ul className="inline-grid flex items-center  grid-cols-2 gap-x-10 gap-y-6 md:gap-x-16 md:grid-cols-3 lg:grid-cols-7">

                        {/* LOGO 1 */}
                      <li>
                       <Image className="w-28 my-auto" src="/banner_react.png" width={200} height={200} />
                      </li>

                         {/* LOGO 1 */}
                         <li>
                       <Image className="w-28 my-auto" src="/banner_nextjs.png" width={200} height={200} />
                      </li>
                           {/* LOGO 1 */}
                           <li>
                       <Image className="w-28 my-auto" src="/banner_vite.png" width={200} height={200} />
                      </li>
                           {/* LOGO 1 */}
                           <li>
                       <Image className="w-28 my-auto" src="/banner_mongo.png" width={200} height={200} />
                      </li>
                        {/* LOGO 1 */}
                        <li>
                       <Image className="w-28 my-auto" src="/banner_postgres.png" width={200} height={200} />
                      </li>
    {/* LOGO 1 */}
    <li>
                       <Image className="w-28 my-auto" src="/banner_open.png" width={200} height={200} />
                      </li>
                        {/* LOGO 2 */}
                      <li>
                      <Image className="w-28 my-auto" src="/banner_aws.png" width={200} height={200} />
                      ...
                      <li>
                        ...
                        {/* LOGO 4 */}
                      <li>
                      <Image className="w-28 my-auto" src="/banner_strapi.png" width={200} height={200} />

                      </li>
                           {/* LOGO 4 */}
                           <li>
                      <Image className="w-28 my-auto" src="/banner_ubunto.png" width={200} height={200} />

                      </li>

                            {/* LOGO 4 */}
                            <li>
                      <Image className="w-28 my-auto" src="/banner_google.png" width={200} height={200} />
                            ...
                            {/* LOGO 4 */}
                            <li>
                      <Image className="w-28 my-auto" src="/banner_node.png" width={200} height={200} />

                      </li>

                        {/* LOGO 8 */}
                        <li>
                      <Image className="w-28 my-auto" src="/banner_algolia.png" width={200} height={200} />

                      </li>
                      
                      <li>
                      <Image className="w-28 my-auto" src="/ banner_aws_services.png" width={200} height={200} />
